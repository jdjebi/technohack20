    ...
    if form.is_valid():
       ...
       # enregistrer l'équipe
        ...
        coep1 = User.objects.create_user(
            username=data['nom_user_coep1'], email=data['emailcoep1'])
        ...
        coep2 = User.objects.create_user(
            username=data['nom_user_coep2'], email=data['emailcoep2'])
        ...
        liste_participant = [(chef_equipe, data['numerochef']),
                             (coep1, data['numerocoep1']), (coep2, data['numerocoep2'])]
...
def activate_compte(request, uidb64, token):
    ...
    if chef_equipe is not None and generate_token.check_token(chef_equipe, token):
        ...
        messages.add_message(request, messages.SUCCESS,
                             "Le compte de votre équipe a bien été activé.")
